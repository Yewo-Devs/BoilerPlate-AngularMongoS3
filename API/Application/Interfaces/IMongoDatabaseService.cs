...
namespace API.Application.Interfaces
{
    ...
    public interface IMongoDatabaseService
    {
        ...
        public Task<T> GetInstanceOfType<T>(DataNodes node, string path = null);
        /// <summary>
        ...
        public Task<IEnumerable<T>> GetCollectionOfType<T>(DataNodes node, FilteringOptions? filteringOptions = null);
        /// <summary>
        ...
        public Task StoreData(DataNodes node, object data, string? path = null, bool generateKey = false);
        /// <summary>
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public Task UpdateData(DataNodes node, string path, object data);
        /// <summary>
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public Task DeleteData(DataNodes node, string path);
    }
}